    ...
    return {
        ...
        execute: function() {
            OrderService = (function () {
                function OrderService(_http, appConstants) {
                    this._http = _http;
                    this.appConstants = appConstants;
                }
                OrderService.prototype.getOrderList = function (asin) {
                    var body = '{"asin":"' + asin + '"}';
                    ...
                    return this._http.post(this.appConstants.OrderListURL, body, options).map(function (res) { return res.json(); }).catch(this.handleError);
                };
