...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "reviewtracker@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "reviewtracker API";

        private String description = "reviewtracker API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "reviewtracker";
