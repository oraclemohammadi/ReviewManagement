...
/**
 * Performance test for the PurchaseOrderItem entity.
 */
class PurchaseOrderItemGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PurchaseOrderItem entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all purchaseOrderItems")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created purchaseOrderItem")
                .get("${new_purchaseOrderItem_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created purchaseOrderItem")
            .delete("${new_purchaseOrderItem_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
